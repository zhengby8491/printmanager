...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/finance/writeoffReceive/ajaxDetailList",
			method : "post",
			...
			cookieIdTable : "print_finance_writeoffReceive_detail",//必须制定唯一的表格cookieID
			...
			onLoadSuccess : function()
			{
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					if (!Helper.basic.hasPermission('finance:writeoffreceive_detail:export'))
					{
			...
			onDblClickRow : function(row)
			{
				...
				var url = Helper.basePath + '/finance/writeoffReceive/view/' + row.master.id;
				var title = "收款核销单";
			...
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">客户 名称：</label>
