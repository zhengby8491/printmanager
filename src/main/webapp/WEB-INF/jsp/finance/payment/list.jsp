...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/finance/payment/ajaxList",
			method : "post",
			...
			cookieIdTable : "print_finance_payment_master",//必须制定唯一的表格cookieID
			...
			columns : [ {
				...
				formatter : function(value, row, index)
				{
					...
					var operator = "";
					if (Helper.basic.hasPermission('finance:payment:list'))
					{
			...
			onLoadSuccess : function()
			{
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					if (!Helper.basic.hasPermission('finance:payment:export'))
					{
	...
	{
		var url = Helper.basePath + '/finance/payment/create';
		var title = "付款单";
