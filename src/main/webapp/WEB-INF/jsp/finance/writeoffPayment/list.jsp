...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/finance/writeoffPayment/ajaxList",
			method : "post",
			...
			cookieIdTable : "print_finance_writeoffPayment_master",//必须制定唯一的表格cookieID
			...
			columns : [ {
				...
				formatter : function(value, row, index)
				{
					...
					var operator = "";
					if (Helper.basic.hasPermission('finance:writeoffPayment:list'))
					{
					}
					operator += '<a title="查看" href="javascript:;" onclick="payment_view(' + row.id + ')" style="padding: 0 8px; color: green"><i class="fa fa-search"></i></a>';
					return operator;
				}
			} ],
		...
		if (!Helper.basic.hasPermission('finance:writeoffPayment:export'))
		{
	...
	/* 新增 */
	function payment_create(id)
	{
		var url = Helper.basePath + '/finance/writeoffPayment/create';
		var title = "付款核销单";
		...
		<div class="page-border">
			...
			<div class="btn-bar" style="margin-bottom: 0">
				<shiro:hasPermission name="finance:writeoffPayment:create">
					<span>
						<a href="javascript:;" onclick="payment_create()" class="nav_btn table_nav_btn">
