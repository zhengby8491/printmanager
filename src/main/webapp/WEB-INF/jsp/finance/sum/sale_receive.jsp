		...
		$("#bootTable").bootstrapTable({
			...
			onLoadSuccess : function(data)
			{
				...
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					if (!Helper.basic.hasPermission('finance:sumsalereceive:export'))
					{
			...
			cookieIdTable : "print_finance_should_receive_sum",//必须制定唯一的表格cookieID
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="财务管理-应收账款汇总表"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap wrap-width">
								<input type="text" class="input-txt input-txt_7" id="customerName" />
