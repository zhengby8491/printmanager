...
<script type="text/javascript">
	...
	$(function(){
	  /* 选择客户 */
		$("#customer_quick_select").click(
			function() {
				Helper.popup.show('选择客户', Helper.basePath
						+ '/quick/customer_select?multiple=false',
						'900', '490');
		});
		...
		$("#bootTable")
				.bootstrapTable(
						{
							url : Helper.basePath
									+ "/finance/log/ajaxReceiveAdvanceLogList",
							method : "post",
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap wrap-width">
								<input type="text" class="input-txt input-txt_7" id="customerName" name="customerName" value="${customerName}" />
