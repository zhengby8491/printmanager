...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/finance/otherPayment/ajaxDetailList",
			method : "post",
			...
			cookieIdTable : "print_finance_other_payment_detail",//必须制定唯一的表格cookieID
			...
			onLoadSuccess : function(data)
			{
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					if (!Helper.basic.hasPermission('finance:otherPayment:detail_export'))
					{
