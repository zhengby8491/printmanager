...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/finance/receive/ajaxDetailList",
			method : "post",
			...
			onLoadSuccess : function()
			{
				...
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					if (!Helper.basic.hasPermission('finance:receive_detail:export'))
					{
			...
			onDblClickRow : function(row)
			{
				...
				var url = Helper.basePath + '/finance/receive/view/' + row.master.id;
				var title = "收款单";
