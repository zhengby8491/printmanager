...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/finance/receive/ajaxList",
			method : "post",
			...
			cookieIdTable : "print_finance_receive_master",//必须制定唯一的表格cookieID
			...
			columns : [ {
				...
				formatter : function(value, row, index)
				{
					...
					var operator = "";
					if (Helper.basic.hasPermission('finance:receive:list'))
					{
					}
			...
			onLoadSuccess : function()
			{
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					if (!Helper.basic.hasPermission('finance:receive:export'))
					{
	...
	{
		var url = Helper.basePath + '/finance/receive/create';
		var title = "收款单";
