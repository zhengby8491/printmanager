...
<script type="text/javascript">
	...
	{
		Helper.request({
			url : Helper.basePath + "/finance/otherReceive/save",
			...
			success : function(data)
			{
				if (data.success)
				{
					...
					location.href = Helper.basePath + '/finance/otherReceive/view/' + data.obj.id;
				} else
				{
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="财务管理-其它收款单-创建"></sys:nav>
				</div>
				<div class="top_nav">
					<shiro:hasPermission name="finance:otherReceive:create">
						<button class="nav_btn table_nav_btn" id="btn_save">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="finance:otherReceive:create,finance:otherPayment:audit">
