...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/finance/otherReceive/ajaxList",
			method : "post",
			...
			cookieIdTable : "print_finance_other_rec_master",//必须制定唯一的表格cookieID
			...
			onLoadSuccess : function()
			{
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					if (!Helper.basic.hasPermission('finance:otherReceive:export'))
					{
	...
	/* 新增其它收款单 */ 
	function create(){
		var url=Helper.basePath + '/finance/otherReceive/create';
		var title="其它收款单";
	...
	function payment_edit(id){
		var url=Helper.basePath + '/finance/otherReceive/edit/' + id;
		var title="其它收款单";
		admin_tab($("<a _href='"+url+"' data-title='"+title+"' />"));
	}
	/* 删除*/
	function payment_delete(id){
    	Helper.message.confirm('确认要删除吗？', function(index) {
			Helper.post(Helper.basePath + '/finance/otherReceive/del/' + id,function(data) {
				if(data.success){
