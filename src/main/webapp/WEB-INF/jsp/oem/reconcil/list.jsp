...
<script type="text/javascript">
	$(function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/oem/reconcil/ajaxList",
			method : "post",
			...
			columns : [ {
				...
				formatter : function(value, row, index)
				{
					...
					if (Helper.basic.hasPermission('oem:reconcil:list'))
					{
					...
					{
						if (Helper.basic.hasPermission('oem:reconcil:edit'))
						{
						...
						if (Helper.basic.hasPermission('oem:reconcil:del'))
						{
		...
		$("#bootTable").on('load-success.bs.table column-switch.bs.table page-change.bs.table search.bs.table', function()
		{
			...
			if ($(".glyphicon-th").next().html() == '')
			{
				...
				if (!Helper.basic.hasPermission('oem:reconcil:export'))
				{
	...
	function reconcil_edit(id)
	{
		...
		var url = Helper.basePath + '/oem/reconcil/edit/' + id;
		var title = "代工对账";
	...
	function reconcil_del(obj, id)
	{
		...
		{
			Helper.post(Helper.basePath + '/oem/reconcil/del/' + id, function(data)
			{
				if (data.success)
				{
