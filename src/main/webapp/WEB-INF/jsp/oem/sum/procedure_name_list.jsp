	...
	$(function()
	{
		...
		$("#year").select('/oem/order/getYearsFromOemOrder', {}, function()
		{
			...
			$("#bootTable").bootstrapTable({
				url : Helper.basePath + "/oem/order/sumOemOrderByProcedure/name",
				method : "post",
				...
				cookieIdTable : "print_oem_sum_procedure_name",//必须制定唯一的表格cookieID
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap wrap-width">
								<input type="text" class="input-txt input-txt_7" id="procedureName" name="procedureName" />
