...
<title>代工订单汇总--按工序</title>
<script type="text/javascript">
	$(function()
	{
		$("input[type='radio']").click(function()
		{
			var url = Helper.basePath + '/oem/order/sumProcedureList/' + $(this).val();
			var title = "代工订单汇总表（按工序）";
		...
		$("#year").select('/oem/order/getYearsFromOemOrder', {}, function()
		{
			...
			$("#bootTable").bootstrapTable({
				url : Helper.basePath + "/oem/order/sumOemOrderByProcedure/class",
				method : "post",
				...
				cookieIdTable : "print_oem_sum_procedure_class",//必须制定唯一的表格cookieID
		...
		$("#bootTable").on('load-success.bs.table column-switch.bs.table page-change.bs.table search.bs.table', function()
		{
			...
			if ($(".glyphicon-th").next().html() == '')
			{
				...
				if (!Helper.basic.hasPermission('oem:sum:procedure:export'))
				{
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="代工管理-分析报表-代工订单汇总表(按工序)"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">工序分类：</label>
							<phtml:list items="${fns:basicList('PROCEDURECLASS')}" valueProperty="id" defaultValue="" defaultOption="请选择" name="procedureClassId" textProperty="name" cssClass="input-txt input-txt_3 hy_select2"></phtml:list>
						</dd>
						<dd class="row-dd">
