	...
	$(function()
	{
		...
		$("#year").select('/oem/order/getYearsFromOemOrder', {}, function()
		{
			...
			$("#bootTable").bootstrapTable({
				url : Helper.basePath + "/oem/order/sumOemOrderBySeller",
				method : "post",
				...
				cookieIdTable : "print_oem_sum_seller",//必须制定唯一的表格cookieID
		...
		$("#bootTable").on('load-success.bs.table column-switch.bs.table page-change.bs.table search.bs.table', function()
		{
			...
			if ($(".glyphicon-th").next().html() == '')
			{
				...
				if (!Helper.basic.hasPermission('oem:sum:seller:export'))
				{
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="代工管理-分析报表-代工订单汇总表(按销售员)"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">销售员：</label>
							<phtml:list items="${fns:basicList('EMPLOYEE')}" valueProperty="id" defaultValue="" defaultOption="请选择" name="employeeId" textProperty="name" cssClass="input-txt input-txt_3 hy_select2"></phtml:list>
						</dd>
						<dd class="row-dd">
