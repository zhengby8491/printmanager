...
<script type="text/javascript">
	...
	function form_submit()
	{
		...
		// 提交到服务器保存
		Helper.request({
			url : Helper.basePath + "/oem/deliver/save",
			...
			success : function(data)
			{
				if (data.success)
				{
					...
					location.href = Helper.basePath + '/oem/deliver/view/' + data.obj.id;
				} else
				{
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="代工管理-代工送货-创建"></sys:nav>
				</div>
				<div class="top_nav">
					<shiro:hasPermission name="oem:deliver:create">
						<button class="nav_btn table_nav_btn" id="btn_save">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="oem:deliver:create,oem:deliver:audit">
						...
						<div class="cl form_content">
							...
							<dl class="cl row-dl">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<phtml:list items="${fns:basicList2('DELIVERYCLASS')}" valueProperty="id" defaultValue="" defaultOption="请选择" selected="${customer.deliveryClassId }" name="deliveryClassId" textProperty="name" cssClass="input-txt input-txt_3 hy_select2"></phtml:list>
									</span>
								</dd>
								<dd class="row-dd">
							...
							<tbody>
								<c:forEach var="detail" items="${order.detailList}" varStatus="status">
								    ...
								    <td>
										...
										<td>
											<input class="tab_input" readonly="readonly" type="text" onmouseover="this.title=this.value" name="detailList.partName" value="${detail.partName }" />
										</td>
										<td>
