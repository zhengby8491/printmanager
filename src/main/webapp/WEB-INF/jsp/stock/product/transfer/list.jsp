...
<title>成品库存调拨列表</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/transfer/list.js?v=${v}"></script>
</head>
<body>
			...
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui label_1">调 出 仓：</label>
							<span class="ui-combo-wrap wrap-width">
								<phtml:list items="${fns:basicListParam2('WAREHOUSE', 'warehouseType','PRODUCT')}" valueProperty="id" defaultValue="" defaultOption="请选择" name="outWarehouseId" textProperty="name" cssClass="input-txt input-txt_1 hy_select2"></phtml:list>
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_1">调 入 仓：</label>
							<span class="ui-combo-wrap wrap-width">
								<phtml:list items="${fns:basicListParam2('WAREHOUSE', 'warehouseType','PRODUCT')}" valueProperty="id" defaultValue="" defaultOption="请选择" name="inWarehouseId" textProperty="name" cssClass="input-txt input-txt_1 hy_select2"></phtml:list>
							</span>
						</dd>
						<dd class="row-dd">
