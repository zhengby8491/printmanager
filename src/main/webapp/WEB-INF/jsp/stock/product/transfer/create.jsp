...
<meta charset="UTF-8">
<title>成品库存调拨</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/transfer/create.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="库存管理-成品库存调拨-创建"></sys:nav>
				</div>
				...
				<div class="top_nav">
					<shiro:hasPermission name="stock:productTransfer:create">
						<button id="btn_save" class="nav_btn table_nav_btn">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="stock:productTransfer:create,stock:productTransfer:audit">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<phtml:list items="${fns:basicListParam2('WAREHOUSE','warehouseType','PRODUCT')}" valueProperty="id" textProperty="name" name="outWarehouseId" 
											onchange="shotCutWindow('WAREHOUSE',true,$(this),'PRODUCT')"  cssClass="input-txt input-txt_3s hy_select2" selected="${outWarehouseId }" />
									</span>
								</dd>
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<phtml:list items="${fns:basicListParam2('WAREHOUSE','warehouseType','PRODUCT')}" valueProperty="id" textProperty="name" name="inWarehouseId" 
											onchange="shotCutWindow('WAREHOUSE',true,$(this),'PRODUCT')"  cssClass="input-txt input-txt_1 hy_select2" selected="${inWarehouseId }" />
									</span>
								</dd>
								<dd class="row-dd">
									<label class="form-label label_ui label_1">调拨单号：</label>
									<span class="ui-combo-wrap">
										<input type="text" class="input-txt input-txt_1" readonly="readonly" value="${billNo }" />
									</span>
								</dd>
							</dl>
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input id="transferTime" name="transferTime" type="text" class="input-txt input-txt_3s Wdate" onFocus="WdatePicker({lang:'zh-cn'})" value="" />
									</span>
								</dd>
								<dd class="row-dd">
							...
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="form_textarea">
										<textarea name="memo" class="noborder" style="width: 652px" placeholder="说点什么...100个字符以内" onKeyUp="Helper.doms.textarealength(this,100)"></textarea>
