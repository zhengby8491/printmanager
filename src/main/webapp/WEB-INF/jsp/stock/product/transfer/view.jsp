...
<meta charset="UTF-8">
<title>成品库存调拨</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/transfer/view.js?v=${v}"></script>
</head>
<body>
	<input id="orderDetailList" value='${fns:toJson(order.detailList)}' type="hidden">
	<input id="transferId" value="${id}" type="hidden">
	<div class="page-container">
		<div class="page-border">
			<!--头部START-->
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="库存管理-成品库存调拨-查看"></sys:nav>
				</div>
					...
					<div class="cl form_content">
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_3s" readonly="readonly" value="${fns:basicInfo('WAREHOUSE',order.outWarehouseId).name}" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">调入仓库：</label>
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_1" readonly="readonly" value="${fns:basicInfo('WAREHOUSE',order.inWarehouseId).name}" />
								</span>
							</dd>
							<dd class="row-dd">
						...
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_3s" readonly="readonly" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${order.transferTime}' type='date' />" />
								</span>
							</dd>
							<dd class="row-dd">
						...
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="form_textarea">
									<textarea class="noborder" name="memo" readonly="readonly" style="width: 652px">${order.memo }</textarea>
								</span>
							</dd>
						</dl>
					</div>
