...
<meta charset="UTF-8">
<title>成品入库</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/in/create.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="库存管理-成品入库-创建"></sys:nav>
				</div>
				...
				<div class="top_nav">
					...
					<shiro:hasManyPermissions name="stock:productIn:create,stock:productIn:audit">
			...
			<form id="form_stockProduct" method="post">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<phtml:list items="${fns:basicListParam2('WAREHOUSE','warehouseType','PRODUCT')}" valueProperty="id" onchange="shotCutWindow('WAREHOUSE',true,$(this),'PRODUCT')" 
											cssClass="input-txt input-txt_1 hy_select2" name="warehouseId" textProperty="name"></phtml:list>
									</span>
								</dd>
								<dd class="row-dd">
				...
				<div>
					<div class="table-container">
						...
						<table class="border-table" style="width: 1600px">
							<thead>
								<tr>
									<th width="40">序号</th>
									<th width="40">操作</th>
							...
							<tbody id="tbody">
								<c:forEach items="${detailList }" var="item" varStatus="status">
									<tr>
										...
										<td>
											<input name="detailList.money" class="tab_input bg_color" type="text" value="" />
										</td>
										...
										<td>
											...
											<input name="detailList.sourceId" class="tab_input" type="hidden" readonly="readonly" value="${item.sourceId}" />
										</td>
										<td>
