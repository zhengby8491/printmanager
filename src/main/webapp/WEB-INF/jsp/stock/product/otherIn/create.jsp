...
<meta charset="UTF-8">
<title>成品其它入库</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/otherIn/create.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="库存管理-成品品其它入库-创建"></sys:nav>
				</div>
				...
				<div class="top_nav">
					<shiro:hasPermission name="stock:productOtherin:create">
						<button id="btn_save" class="nav_btn table_nav_btn">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="stock:productOtherin:create,stock:productOtherin:audit">
							...
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap wrap-width">
										<phtml:list items="${fns:basicListParam2('WAREHOUSE','warehouseType','PRODUCT')}" valueProperty="id" name="warehouseId" 
											onchange="shotCutWindow('WAREHOUSE',true,$(this),'PRODUCT')" cssClass="input-txt input-txt_1 hy_select2" textProperty="name"></phtml:list>
									</span>
								</dd>
								<dd class="row-dd">
							...
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="form_textarea">
										<textarea class="noborder" name="memo" style="width: 998px" placeholder="说点什么...100个字符以内" onKeyUp="Helper.doms.textarealength(this,100)"></textarea>
