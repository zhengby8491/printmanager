...
<meta charset="UTF-8">
<title>成品库存盘点</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/inventory/edit.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="库存管理-成品库存盘点-编辑"></sys:nav>
				</div>
				...
				<div class="top_nav">
					...
					<shiro:hasManyPermissions name="stock:productInventory:edit,stock:productInventory:audit">
						...
						<div class="cl form_content">
							<dl class="cl row-dl">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input id="inventoryTime" name="inventoryTime" type="text" class="input-txt input-txt_1 Wdate" onFocus="WdatePicker({lang:'zh-cn'})" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${order.inventoryTime }' type='date' />" />
									</span>
								</dd>
								<dd class="row-dd">
							...
							<tbody id="tbody">
								<c:forEach items="${order.detailList }" var="item" varStatus="status">
									<tr>
										...
										<td>
											<input name="detailList.stockQty" class="tab_input" type="text" readonly="readonly" value="${item.stockQty }" />
										</td>
										...
										<td style="display: none">
											<input name="detailList.stockProductId" class="tab_input id_${item.stockProductId }" type="hidden" readonly="readonly" value="${item.stockProductId }" />
										</td>
