...
<title>成品库存盘点列表</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/inventory/list.js?v=${v}"></script>
</head>
<body>
			...
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">盘点单号：</label>
