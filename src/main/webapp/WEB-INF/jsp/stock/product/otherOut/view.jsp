...
<meta charset="UTF-8">
<title>成品其它出库</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/product/otherOut/view.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="库存管理-成品其它出库-查看"></sys:nav>
				</div>
					...
					<div class="cl form_content">
						<dl class="cl row-dl">
							...
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_3s" readonly="true" value="${order.billNo }" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">出库日期：</label>
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_1" readonly="true" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${order.outTime}' type='date' />" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">出 库 人：</label>
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_1" readonly="true" value="${fns:basicInfoFiledValue('EMPLOYEE',order.employeeId,'name')}" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">制 单 人：</label>
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_1" readonly="true" value="${order.createName }" />
								</span>
							</dd>
							...
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_1" readonly="true" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${order.createTime}' type='date' />" />
								</span>
							</dd>
						</dl>
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="form_textarea">
									<textarea class="noborder" name="memo" readonly="readonly" style="width: 979px">${order.memo }</textarea>
								</span>
							</dd>
						</dl>
					</div>
