...
<title>材料其它入库列表</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/material/otherIn/list.js?v=${v}"></script>
</head>
<body>
			...
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd"">
							<label class="form-label label_ui">入 库 人：</label>
