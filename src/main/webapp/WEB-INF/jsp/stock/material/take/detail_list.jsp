...
<title>生产领料明细</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/material/take/detail_list.js?v=${v}"></script>
</head>
<body>
				...
				<div class="cl order-info">
					...
					<dl class="cl hide_container" style="display: none;" id="more_div">
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap">
								<phtml:list cssClass="input-txt input-txt_13 hy_select2" items="${fns:basicListParam2('WAREHOUSE', 'warehouseType','MATERIAL')}" valueProperty="id" textProperty="name" defaultValue="" defaultOption="请选择" name="warehouseId"></phtml:list>
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_1">生产单号：</label>
							<span class="ui-combo-wrap">
								<input type="text" class="input-txt input-txt_6" name="sourceBillNo" id="sourceBillNo" />
							</span>
						</dd>
					</dl>
				</div>
