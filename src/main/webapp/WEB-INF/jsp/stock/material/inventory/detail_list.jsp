...
<title>材料库存盘点明细</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/material/inventory/detail_list.js?v=${v}"></script>
</head>
<body>
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap wrap-width">
								<input type="text" class="input-txt input-txt_0" id="materialName" name="materialName" />
