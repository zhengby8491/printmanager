...
<title>材料出入明细</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/material/logDetailList.js?v=${v}"></script>
</head>
<body>
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-noborder">
								<phtml:list items="${billTypeList}" textProperty="text" name="billType" cssClass="hy_select2 input-txt input-txt_3s" defaultValue="" defaultOption="请选择" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_1">材料规格：</label>
							<span class="ui-combo-wrap">
								<input type="text" class="input-txt input-txt_1" id="specifications" name="specifications" value=""/>
							</span>
						</dd>
						<dd class="row-dd">
