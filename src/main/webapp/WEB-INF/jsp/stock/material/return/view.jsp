...
<script type="text/javascript" src="${ctxStatic}/site/stock/material/return/view.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="库存管理-生产退料-查看"></sys:nav>
				</div>
				<div class="top_nav">
					...
					<div class="cl form_content">
						...
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_1 Wdate" readonly="readonly" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${order.returnTime}' type='date' />" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">退 料 人：</label>
								<span class="ui-combo-noborder">
									<input type="text" class="input-txt input-txt_9" readonly="readonly" value="${fns:basicInfo('EMPLOYEE',order.returnEmployeeId).name}" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">收 料 人：</label>
								<span class="ui-combo-noborder">
									<input type="text" class="input-txt input-txt_6" readonly="readonly" value="${fns:basicInfo('EMPLOYEE',order.receiveEmployeeId).name}" />
								</span>
							</dd>
							<dd class="row-dd">
						...
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="form_textarea">
									<textarea class="noborder" name="memo" readonly="readonly" style="width: 861px">${order.memo }</textarea>
								</span>
							</dd>
						</dl>
					</div>
