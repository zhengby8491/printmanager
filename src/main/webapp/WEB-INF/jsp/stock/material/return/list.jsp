...
<title>生产退料列表</title>
<script type="text/javascript" src="${ctxStatic}/site/stock/material/return/list.js?v=${v}"></script>
</head>
<body>
			...
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">退 料 人：</label>
							<span class="ui-combo-wrap wrap-width">
								<phtml:list items="${fns:basicList('EMPLOYEE')}" valueProperty="id" defaultValue="" defaultOption="请选择" name="returnEmployeeId" textProperty="name" cssClass="input-txt input-txt_1 hy_select2"></phtml:list>
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui">收 料 人：</label>
							<span class="ui-combo-wrap wrap-width">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">退料单号：</label>
