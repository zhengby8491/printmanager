...
<meta charset="UTF-8">
<title>采购对账明细</title>
<script type="text/javascript" src="${ctxStatic}/site/purch/reconcil/detail.js?v=${v}"></script>
</head>
<body>
				...
				<div class="cl order-info">
					...
					<dl class="cl" style="display: none;" id="more_div">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<input style="padding-right: 24px;" id="specifications" type="text" class="input-txt input-txt_3" name="specifications" value="${specifications}" />
							</span>
						</dd>
						<dd class="row-dd">
					...
					<dl class="cl" style="display: none;" id="more_div2">
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<input id="orderBillNo" type="text" class="input-txt input-txt_13" name="orderBillNo" value="${orderBillNo}" />
							</span>
						</dd>
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<input style="padding-right: 24px;" id="sourceBillNo" type="text" class="input-txt input-txt_7" name="sourceBillNo" value="${sourceBillNo}" />
							</span>
						</dd>
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<input style="padding-right: 24px;" id="workBillNo" type="text" class="input-txt input-txt_3" name="workBillNo" value="${workBillNo}" />
							</span>
						</dd>
					</dl>
