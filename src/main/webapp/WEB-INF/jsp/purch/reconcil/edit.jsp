...
<script type="text/javascript" src="${ctxStatic}/site/purch/reconcil/edit.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="采购管理-采购对账-编辑"></sys:nav>
				</div>
				<div class="top_nav">
					...
					<shiro:hasManyPermissions name="purch:reconcil:edit,purch:reconcil:audit">
			...
			<form id="purchReconcilAction" method="post">
						...
						<div class="cl form_content">
							<dl class="cl row-dl">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="text" class="input-txt input-txt_1 Wdate" onFocus="WdatePicker({lang:'zh-cn',minDate: '%y-%M-%d'})" name="reconcilTime" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${purchReconcil.reconcilTime}' type='date' />" />
									</span>
								</dd>
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										...
										<input type="text" class="input-txt input-txt_1" readonly="readonly" name="employeeName" id="employeeName" value="${purchReconcil.employeeName }" />
									</span>
								</dd>
							</dl>
							<dl class="cl row-dl">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="hidden" name="employeeId" id="employeeId" value="${purchOrder.employeeId }" />
										<input type="text" class="input-txt input-txt_1" readonly="readonly" name="employeeName" id="employeeName" value="${purchReconcil.billNo }" />
									</span>
								</dd>
								<dd class="row-dd">
									<label class="form-label label_ui label_6">备注：</label>
									<span class="form_textarea">
										<textarea class="noborder" name="memo" style="width: 907px" placeholder="说点什么...100个字符以内" onKeyUp="Helper.doms.textarealength(this,100)">${purchReconcil.memo }</textarea>
							...
							<input id="id" type="hidden" name="id" value="${purchReconcil.id }">
							<input type="hidden" name="billNo" value="${purchReconcil.billNo }">
							<input type="hidden" name="companyId" value="${purchReconcil.companyId }">
				...
				<div>
					<div class="table-container">
						<table class="border-table" id="detailList" style="width: 1400px">
							<thead>
								<tr>
									<th width="40">序号</th>
									<th width="40">操作</th>
									...
									<th width="140" style="display: none">生产单号</th>
							...
							<tbody>
								<c:forEach items="${purchReconcil.detailList}" var="item" varStatus="status">
									<tr>
										...
										<td style="display: none">
											<input class="tab_input" type="text" name="detailList.workBillNo" readonly="readonly" value="${item.workBillNo}" />
										</td>
										<td style="display: none">
										...
										<td>
											<input class="bg_color tab_input memo" onmouseover="this.title=this.value" name="detailList.memo" type="text" value="${item.memo }" />
					...
					<dl class="cl row-dl-foot">
						<shiro:hasPermission name="purch:reconcil:money">
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input id="totalMoney" name="totalMoney" type="text" class="input-txt input-txt_1" readonly="readonly" value="${purchReconcil.totalMoney }" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_7">金额(不含税)：</label>
								<span class="ui-combo-wrap">
									<input id="noTaxTotalMoney" name="noTaxTotalMoney" type="text" class="input-txt input-txt_1" readonly="readonly" value="${purchReconcil.noTaxTotalMoney }" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_7">税 额：</label>
								<span class="ui-combo-wrap">
									<input id="totalTax" name="totalTax" type="text" class="input-txt input-txt_1" readonly="readonly" value="${purchReconcil.totalTax }" />
								</span>
							</dd>
						</shiro:hasPermission>
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap">
								<input type="text" class="input-txt input-txt_1" readonly="readonly" value="${purchReconcil.currencyType.text}" />
							</span>
						</dd>
					</dl>
					<dl class="cl row-dl-foot">
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap">
								<input type="text" class="input-txt input-txt_1" readonly="readonly" value="${purchReconcil.createName} " />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_7">制单日期：</label>
							<span class="ui-combo-wrap">
								<input type="text" class="input-txt input-txt_1" readonly="readonly" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${purchReconcil.createTime}' type='date' />" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_7">审 核 人：</label>
							<span class="ui-combo-wrap">
								<input type="text" class="input-txt input-txt_1" readonly="readonly" value="${purchReconcil.checkUserName }" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_7">审核日期：</label>
							<span class="ui-combo-wrap">
								<input type="text" class="input-txt input-txt_1" readonly="readonly" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${purchReconcil.checkTime}' type='date' />" />
							</span>
						</dd>
					</dl>
				</div>
