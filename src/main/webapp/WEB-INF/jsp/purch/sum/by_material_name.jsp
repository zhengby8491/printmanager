...
<script type="text/javascript" src="${ctxStatic}/site/purch/sum/by_material_name.js?v=${v}"></script>
</head>
<body>
...
<script type="text/javascript" src="${ctxHYUI}/plugins/Highcharts/js/highcharts-3d.js"></script>
<title>原材料采购订单汇总</title>
<script type="text/javascript" src="${ctxStatic}/site/purch/stock/by_material_name.js?v=${v}"></script>
</head>
<body>
	<div class="page-container">
		<div class="page-border">
