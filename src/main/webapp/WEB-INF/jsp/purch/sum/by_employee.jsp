...
<title>采购员采购订单汇总</title>
<script type="text/javascript" src="${ctxStatic}/site/purch/sum/by_employee.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="采购管理-分析报表-采购员采购订单汇总"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
						...
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap" class="form_text">
									<select class="input-txt input-txt_0 hy_select2" id="year" cssname="year"></select>
									<input type="hidden" id="dateMin" />
									<input type="hidden" id="dateMax" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">采购员：</label>
								<phtml:list items="${fns:basicList('EMPLOYEE')}" valueProperty="name" cssClass="input-txt input-txt_1 hy_select2" name="employeeName" textProperty="name" defaultOption="请选择"></phtml:list>
							</dd>
							<dd class="row-dd">
