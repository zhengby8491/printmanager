...
<script type="text/javascript" src="${ctxStatic}/site/purch/sum/by_supplier_name.js?v=${v}"></script>
</head>
<body>
				...
				<div>
					<div class="cl order-info">
						<dl class="cl row-dl">
							...
							<dd class="row-dd">
								<label class="form-label label_ui label_7">供应商名称：</label>
...
<script type="text/javascript" src="${ctxHYUI}/plugins/Highcharts/js/highcharts-3d.js"></script>
<title>供应商采购订单汇总</title>
<script type="text/javascript" src="${ctxStatic}/site/purch/stock/by_supplier_name.js?v=${v}"></script>
</head>
<body>
	<div class="page-container">
		<div class="page-border">
