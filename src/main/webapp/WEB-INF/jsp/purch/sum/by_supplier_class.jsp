...
<script type="text/javascript" src="${ctxStatic}/site/purch/sum/by_supplier_class.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="采购管理-分析报表-供应商采购订单汇总"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
				...
				<div>
					<div class="cl order-info">
						<dl class="cl row-dl">
							...
							<dd class="row-dd">
								<label class="form-label label_ui label_7">供应商分类：</label>
								<span class="ui-combo-wrap wrap-width">
									<phtml:list items="${fns:basicList('SUPPLIERCLASS')}" valueProperty="name" textProperty="name" name="supplierClassName" defaultOption="请选择" defaultValue="" cssClass="input-txt input-txt_1 hy_select2" />
								</span>
							</dd>
							<dd class="row-dd">
...
<script type="text/javascript" src="${ctxHYUI}/plugins/Highcharts/js/highcharts-3d.js"></script>
<title>供应商采购订单汇总</title>
<script type="text/javascript" src="${ctxStatic}/site/purch/stock/by_supplier_class.js?v=${v}"></script>
</head>
<body>
	<div class="page-container">
		<div class="page-border">
