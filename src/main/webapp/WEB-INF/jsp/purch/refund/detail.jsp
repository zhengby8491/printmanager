...
<meta charset="UTF-8">
<title>采购退货明细</title>
<script type="text/javascript" src="${ctxStatic}/site/purch/refund/detail.js?v=${v}"></script>
</head>
<body>
			...
			<div class="cl">
				<div class="cl order-info">
					...
					<dl class="cl" style="display: none;" id="more_div">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap form_text wrap-width">
								<input id="specifications" type="text" class="input-txt input-txt_3" name="specifications" value="${specifications}" />
							</span>
						</dd>
						<dd class="row-dd">
					...
					<dl class="cl" style="display: none;" id="more_div2">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">入&nbsp;库&nbsp;单&nbsp;号&nbsp;：</label>
							<span class="ui-combo-wrap" class="form_text">
								<input id="sourceBillNo" type="text" class="input-txt input-txt_20" name="sourceBillNo" value="${sourceBillNo}" />
							</span>
						</dd>
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap form_text wrap-width">
								<input id="workBillNo" type="text" class="input-txt input-txt_3" name="workBillNo" value="${workBillNo}" />
							</span>
						</dd>
