...
<script type="text/javascript" src="${ctxStatic}/site/purch/stock/edit.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="采购管理-采购入库-编辑"></sys:nav>
				</div>
				<div class="top_nav">
					<shiro:hasPermission name="purch:stock:edit">
						<button id="btn_save" class="nav_btn table_nav_btn">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="purch:stock:edit,purch:stock:audit">
				...
				<div class="form-container">
					<div class="form-wrap">
						<div class="cl form_content">
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="text" class="input-txt input-txt_20" name="supplierName" readonly="readonly" value="${purchStock.supplierName}" />
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="text" onfocus="WdatePicker({lang:'zh-cn'})" class="input-txt input-txt_1 Wdate" id="storageTime" name="storageTime" value="<fmt:formatDate pattern="yyyy-MM-dd"  value='${purchStock.storageTime}' type='date' />" />
									</span>
								</dd>
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										...
										<input type="text" class="input-txt input-txt_1" readonly="readonly" name="employeeName" id="employeeName" value="${purchStock.employeeName }" />
									</span>
								</dd>
							</dl>
							<dl class="cl row-dl">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<phtml:list items="${fns:basicList2('PAYMENTCLASS')}" valueProperty="id" cssClass="input-txt input-txt_1 hy_select2" name="paymentClassId" textProperty="name" selected="${purchStock.paymentClassId }"></phtml:list>
									</span>
								</dd>
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="text" class="input-txt input-txt_1" readonly="readonly" value="${purchStock.billNo }" />
									</span>
								</dd>
							</dl>
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="form_textarea">
										<textarea class="noborder" name="memo" style="width: 1078px" placeholder="说点什么...100个字符以内" onKeyUp="Helper.doms.textarealength(this,100)">${purchStock.memo }</textarea>
							...
							<input id="id" type="hidden" name="id" value="${purchStock.id }">
							...
							<tbody name="tbody">
								<c:forEach items="${purchStock.detailList}" var="item" varStatus="status">
									<tr name="tr">
										...
										<td>
											<input name="detailList.freeQty" class="bg_color tab_input qty constraint_decimal" type="text" value="<fmt:formatNumber value="${item.freeQty }" type="currency" pattern="0.####"/>" />
											<input name="detailList.freeValuationQty" type="hidden" value="<fmt:formatNumber value="${item.freeValuationQty }" type="currency" pattern="0.####"/>">
										</td>
