...
<meta charset="UTF-8">
<title>采购订单明细</title>
<script type="text/javascript" src="${ctxStatic}/site/purch/order/detail.js?v=${v}"></script>
</head>
<body>
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<phtml:list items="${fns:basicList2('EMPLOYEE')}" valueProperty="id" cssClass="input-txt input-txt_3 hy_select2" name="employeeId" textProperty="name" defaultOption="请选择"></phtml:list>
							</span>
						</dd>
						<dd class="row-dd">
