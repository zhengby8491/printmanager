...
<title>查看送货单</title>
<script type="text/javascript" src="${ctxStatic}/site/sale/deliver/view.js?v=${v}"></script>
</head>
<body>
	<div class="page-container">
		<div class="page-border">
			<input id="saleDeliverId" type="hidden" value="${id}"/>
			<!--导航按钮-->
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="销售管理-销售送货-查看"></sys:nav>
				</div>
						...
						<div class="btn-group" id="btn_transmit">
							...
							<div class="template_div">
								<ul class='dropdown-menu' role='menu'>
									<li>
										<a title='生成生产工单' id="transmitToReturn">生成销售退货</a>
									</li>
									<li>
										<a title='生成销售送货单' id="transmitToReconcil">生成销售对账</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="cl form_content">
						<dl class="cl row-dl">
							...
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_3" readonly="true" id="deliveryTime" pattern="yyyy-MM-dd" />
								</span>
							</dd>
							<dd class="row-dd">
								<label class="form-label label_ui label_1">销售员：</label>
								<span class="ui-combo-wrap">
									<input type="text" class="input-txt input-txt_3" readonly id="employeeName" />
								</span>
							</dd>
						</dl>
						<dl class="cl row-dl">
