...
<title>销售送货单明细</title>
<script type="text/javascript" src="${ctxStatic}/site/sale/deliver/detail_list.js?v=${v}"></script>
</head>
<body>
				...
				<div class="cl order-info">
					...
					<dl class="cl hide_container" style="display: none;" id="more_div">
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap form_text">
								<phtml:list items="${fns:basicListParam2('WAREHOUSE', 'warehouseType','PRODUCT')}" valueProperty="id" defaultOption="请选择" defaultValue="-1" selected="${warehouseId }" name="warehouseId" textProperty="name" cssClass="input-txt input-txt_13 hy_select2"></phtml:list>
							</span>
						</dd>
						<dd class="row-dd">
