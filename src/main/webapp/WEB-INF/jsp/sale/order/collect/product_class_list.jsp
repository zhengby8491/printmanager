...
<title>销售订单汇总--按产品</title>
<script type="text/javascript" src="${ctxStatic}/site/sale/order/collect/product_class_list.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="销售管理-分析报表-销售订单汇总表(按产品)"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui">产品分类：</label>
							<phtml:list items="${fns:basicList('PRODUCTCLASS')}" valueProperty="id" defaultValue="" defaultOption="请选择" name="productClassId" textProperty="name" cssClass="input-txt input-txt_3 hy_select2"></phtml:list>
						</dd>
						<dd class="row-dd">
