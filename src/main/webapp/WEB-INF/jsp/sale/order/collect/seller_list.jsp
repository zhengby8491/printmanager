...
<title>销售订单汇总--按销售员</title>
<script type="text/javascript" src="${ctxStatic}/site/sale/order/collect/seller_list.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="销售管理-分析报表-销售订单汇总表(按销售员)"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
