...
<script type="text/javascript" src="${ctxStatic}/site/sale/order/collect/product_name_list.js?v=${v}"></script>
</head>
<body>
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap wrap-width">
								<input type="text" class="input-txt input-txt_7" id="productName" name="productName" />
