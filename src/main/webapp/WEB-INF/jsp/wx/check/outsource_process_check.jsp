	...
	<div class="page page-current">
		<div class="searchbar">
			...
			<div class="search-input">
				...
				<input type="search" id="search" placeholder="搜索发外单号/供应商名称">
			</div>
		</div>
					...
					<label class="label-checkbox">		
						<div class="check_item_head cl">							
							<div class="item-kv pull-left">
						            <div class="item-key w-56">发外单号:</div>
						...
						<table>
							<tbody>
						        		...
						        		<div style="padding: 0 0.2rem 0 1.3rem;">			        			
									        <div class="item-kv">
									         ...
									         <div class="item-bottom" style="padding-bottom: 0.1rem;">
												...
												<div>
									            	<div style="margin-left:.5rem">联系电话:</div>
			        			...
			        			<tr class="bg-w">
				        			...
				        			<span class="">(含税额:<span class="color-o">￥<span>{{=it[k].tax}}</span></span>)</span></td>
				        		</tr>
					        				...
					        				<div class="check_item_detail">
					        					...
					        					<div class="cl">
					        						 <div class="item-kv pull-left">
											            <div class="item-value">
															{{if(it[k].productName!=null){}}
	    														{{=it[k].productName}}&nbsp;&nbsp;&nbsp;&nbsp;
	    													{{}}}
															{{if(it[k].procedureName!=null){}}
	    														{{=it[k].procedureName}}&nbsp;&nbsp;&nbsp;&nbsp;
	    													{{}}}
															{{if(it[k].style!=null){}}
	    														{{=it[k].style}}
					        					...
					        					<div class="cl">				        																	        
													<div class="row no-gutter">										            
											            <div class="item-value color-o col-30">￥{{=it[k].price}}</div>
											            <div class="item-value col-20">X</div>	
											            <div class="item-value col-50">{{=it[k].qty}}{{=it[k].unitName||'张'}}</div>	
											        </div>
													<div class="row no-gutter">
	...
	<script type="text/javascript">	    
        ...
        {                            
            ...
            function addItems(){
                HYWX.loadMore.addData({
                    url:'${ctx}/wx/check/outSourceCheckList',
                    data:{
        ...
        $(document).on("click",".audit_btn",function(){
        	...
        	$.confirm('确认审核?', '',function (){
	        	 HYWX.request({
	                url:'${ctx}/wx/check/outSourceCheck',
	                data:{"id":billId},
	                dataType:"json",
        	...
        	if($(this).hasClass("active")){
        		$.confirm('确认审核?', '',
        		        ...
        		        function () {
        		          ...
        		          HYWX.requestByObj({
                              url:'${ctx}/wx/check/outSourceCheckAll',
                              data:{"ids":ids},
                              success:function(data){
        ...
        function addDetail($a){
        		...
        		if($a.find(".check_item_td").children().eq(0).hasClass("check_detail_preloader")){
        			HYWX.requestByObj({
                        url:'${ctx}/wx/check/outSourceCheckDetail',
                        data:{"id":billId},
                        success:function(data){
