	...
	<div class="page page-current">
		<div class="searchbar">
			...
			<div class="search-input">
				...
				<input type="search" id="search" placeholder="搜索核销单号/供应商名称">
			</div>
		</div>
	...
	<script type="text/javascript">	    
        ...
        {                            
            ...
            function addItems(){
                HYWX.loadMore.addData({
                    url:'${ctx}/wx/check/writeoffPaymentCheckList',
                    data:{
        ...
        $(document).on("click",".audit_btn",function(){
        	...
        	$.confirm('确认审核?', '',function (){
	        	 HYWX.request({
	                url:'${ctx}/wx/check/writeoffPaymentCheck',
	                data:{"id":billId},
	                dataType:"json",
        	...
        	if($(this).hasClass("active")){
        		$.confirm('确认审核?', '',
        		        ...
        		        function () {
        		          ...
        		          HYWX.requestByObj({
                              url:'${ctx}/wx/check/writeoffPaymentCheckAll',
                              data:{"ids":ids},
                              success:function(data){                                
        ...
        function addDetail($a){
        		...
        		if($a.find(".check_item_td").children().eq(0).hasClass("check_detail_preloader")){
        			HYWX.requestByObj({
                        url:'${ctx}/wx/check/writeoffPaymentCheckDetail',
                        data:{"id":billId},
                        success:function(data){                            
