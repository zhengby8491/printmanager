	...
	<div class="page page-current">
		<div class="searchbar">
			...
			<div class="search-input">
				...
				<input type="search" id="search" placeholder="搜索销售单号/客户名称">
			</div>
		</div>
					...
					<label class="label-checkbox">		
						<div class="check_item_head cl">							
							<div class="item-kv pull-left">
						            <div class="item-key w-56">销售单号:</div>
						        		...
						        		<div style="padding: 0 0.2rem 0 1.3rem;">			        			
									        <div class="item-kv">
									         ...
									         <div class="item-bottom" style="padding-bottom: 0.1rem;">
												...
												<div>
									            	<div style="margin-left:0.5rem">联系电话:</div>
	...
	<script id="detaillisttmpl" type="text/x-dot-template">
										<div class="check_detail_content">
					        				...
					        				<div class="check_item_detail">
					        					...
					        					<div class="cl">
					        						 <div class="item-kv pull-left">
											            <div class="item-value">{{=it[k].productName||''}}&nbsp;&nbsp;&nbsp;&nbsp;
															{{if(it[k].style!=null){}}
	    														{{=it[k].style}}
	    													{{}}}
														 </div>  
					        					...
					        					<div class="cl">				        																	        
													<div class="row no-gutter">										            
											            ...
											            <div class="item-value col-50">{{=it[k].qty}}{{=it[k].unitName}}</div>	
											        </div>
													<div class="row no-gutter">
	...
	<script type="text/javascript">	    
        ...
        {                            
            ...
            function addItems(){
                HYWX.loadMore.addData({
                    url:'${ctx}/wx/check/saleCheckList',
                    data:{
        ...
        function addDetail($a){
        		...
        		if($a.find(".check_item_td").children().eq(0).hasClass("check_detail_preloader")){
        			HYWX.requestByObj({
                        url:'${ctx}/wx/check/saleCheckDetail',
                        data:{"id":billId},
                        success:function(data){
