...
<body>
                    ...
                    <li class="mar-btm6" data-index="{{= it[k].index}}">
				      ...
				      <div class="item">  
				          ...
				          <div class="item-kv">
				            	...
				            	<div class="item-value w-60p">{{= it[k].saleQty }}{{= it[k].unitName||'张' }}</div>
						  </div>
						  <div class="item-kv">
	...
	<script id="moretmpl" type="text/x-dot-template">                    
				      <div class="item">  
				          ...
				          <div class="item-kv">
				            	<div class="item-key w-69">销售数量 :</div>
				            	<div class="item-value">{{= it.saleQty }}{{= it.unitName ||'张'}}</div>
						  </div>
						<div class="item-kv">
				            	<div class="item-key w-69">销售金额 :</div>
				            	<div class="item-value">￥{{= it.saleMoney }}</div>
						  </div>
						  <div class="item-kv">
				            	<div class="item-key w-69">生产数量  :</div>
				            	<div class="item-value">{{= it.produceedQty }}{{= it.unitName ||'张'}}</div>
						  </div>
						  <div class="item-kv">
				            	<div class="item-key w-69">送货数量  :</div>
				            	<div class="item-value">{{= it.deliverQty }}{{= it.unitName ||'张'}}</div>
						  </div>						 
						  <div class="item-kv">
						  ...
						  <div class="item-kv">
				            	<div class="item-key w-69">收款金额  :</div>
				            	<div class="item-value">￥{{= it.receiveMoney }}</div>
						  </div>
				      </div>
	</script>
        ...
        {                            
            ...
            function addItems(){
                HYWX.loadMore.addData({
                    url:'${ctx}/wx/schedule/saleSchedule',
                    data:{
