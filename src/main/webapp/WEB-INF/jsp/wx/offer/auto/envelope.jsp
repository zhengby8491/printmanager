			...
			<form action="" id="quote_form" method="post">
				<table class="offer_table">
					<tr>
						<td>成品尺寸</td>
						<td>
							<phtml:list name="spec" textProperty="text" valueProperty="style" cssClass="input-txt input-txt_3 hy_select" type="com.huayin.printmanager.persist.enumerate.OfferEnvelopeSpecType" selected="" />
							<!---------------------------------------- 公共 > 自定义尺寸填写 --------------------------------------------->
