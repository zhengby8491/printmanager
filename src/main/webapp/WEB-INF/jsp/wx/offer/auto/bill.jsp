				...
				<table class="offer_table">
					...
					<tr>
						...
						<td>
							...
							本
							<input type="number" id="pageType" class="constraint_negative amount" name="pageType">
							页
							<phtml:list name="sheetType" textProperty="text" cssClass="input-txt input-txt_25 hy_select" type="com.huayin.printmanager.persist.enumerate.OfferSheetType" selected="" />
							<!-- 设计费 -->
							<div class="design" style="margin-top: 3px;">
