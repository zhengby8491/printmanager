...
<body>
	<div class="page page-current sum_content">
		<div class="buttons-tab row no-gutter">
			...
			<span class="tab-link button col-30" id="SHOULD">应付款</span>
			<span class="tab-link button col-30" id="EXPIRE">到期应付</span>
        ...
        {       		
            ...
            function addItems(){
                HYWX.loadMore.addData({
                    url:"${ctx}/wx/sum/outsourceSupplierSum",
                    data:{
            ...
            $(".tab-link").on("singleTap",function(){
            	 if($(this).hasClass("active")){
            		...
            		if($(this).attr("id")=="DAY"){            			   			
            			...
            			$(".sum_all_text").text("应付款金额");
            		}else if($(this).attr("id")=="EXPIRE"){
            			$(".sum_all_text").text("到期应付金额");
            		}
            	}           
            }) 
            //点击进入明细
            $(document).on("click",".sum_item",function(){
            	...
            	var type = $("#queryType").val();
          	    window.location.href="${ctx}/wx/sum/view/outSourceSumDetail?supplierId="+supplierId+"&type="+type;
            })
        })
    </script>
</body>
