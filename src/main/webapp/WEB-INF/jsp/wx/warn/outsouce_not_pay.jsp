	...
	<div class="page page-current">
		<div class="searchbar">
			...
			<div class="search-input">
				...
				<input type="search" id="search" placeholder="搜索发外单号/工序名称/供应商名称">
			</div>
		</div>
                    ...
                    <li class="mar-btm6" data-index="{{= it[k].index}}">
				      ...
				      <div class="item">  
				          <div class="item-kv">
				            ...
				            <div class="item-value color-o w-55p" title="111111">
								{{? it[k].name}}
				          ...
				          <div class="item-bottom">
							...
							<div>
				            	<div style="margin-left:.5rem">加工金额:</div>
				            	<div class="color-o">￥{{= it[k].money }}</div>
							</div>
				          </div>
						   <div class="item-kv">
				            	<div class="item-key w-69">发外单号 :</div>
				            	<div class="item-value">{{= it[k].billNo||'' }}</div>
				            </div>
							<div class="circle" data-pct="{{= it[k].deliveryPercent }}">
    							...
    							<div class="mask">
									<div>交货天数</div>
									<span class="deliverDay">{{=it[k].paymentDay}}</span><span class="color-b">天</span>
								</div>
  							</div>
				       </div>
                    </li>
        ...
        {                            
            ...
            function addItems(){
                HYWX.loadMore.addData({
                    url:'${ctx}/wx/warn/outSourceNotPayment',
                    data:{
