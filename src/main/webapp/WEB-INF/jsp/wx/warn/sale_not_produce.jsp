	...
	<div class="page page-current">
		<div class="searchbar">
			...
			<div class="search-input">
				...
				<i class="icon iconfont icon-clear empty_btn"></i>
			</div>
		</div>
                    ...
                    <li class="mar-btm6" data-index="{{= it[k].index}}">
				      ...
				      <div class="item">  
				          ...
				          <div class="item-bottom">
							<div style="">
				            	<div class="w-69">销售数量 :</div>
				            	<div class="w_num_unit">{{= it[k].saleQty }}{{= it[k].unitName }}</div>
							</div>
							<div>
				            	<div style="margin-left:.5rem">已生产:</div>
				            	<div class="">{{= it[k].produceedQty }}{{= it[k].unitName }}</div>
							</div>
				          </div>
        ...
        {                            
            ...
            function addItems(){
                HYWX.loadMore.addData({
                    url:'${ctx}/wx/warn/saleNotProduction',
                    data:{
