...
<meta charset="UTF-8">
<title>选择工单</title>
<script type="text/javascript" src="${ctxStatic}/site/produce/quick_select_work.js?v=${v}"></script>
</head>
<body>
			...
			<div class="layer_table_container" style="left: 0; width: 787px;">
				<div class="cl layer_top">
					<div class="row-dd" style="margin-left: 5px">
						<label class="form-label label_ui"></label> <span class="ui-combo-wrap" class="form_text"> <sys:dateConfine label="制单日期" /> <input type="text" class="input-txt input-txt_9" id="billNo" name="billNo" value="${billNo }" placeholder="生产单号" />
						</span>
