...
<script type="text/javascript" src="${ctxStatic}/site/begin/account/create.js?v=${v }"></script>
<title>账户期初新增</title>
</head>
<body>
	<div class="page-container">
		<div class="page-border">
			...
			<div class="cl">
				...
				<div class="top_nav">
					<shiro:hasPermission name="begin:account:create">
						<button id="btn_save" class="nav_btn table_nav_btn">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="begin:account:create,begin:account:audit">
