...
<script type="text/javascript" src="${ctxStatic}/site/begin/customer/view.js?v=${v }"></script>
<title>客户期初查看</title>
</head>
<body>
						...
						<dl class="cl row-dl">
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap">
									<input id="billNo" type="text" name="billNo" class="input-txt input-txt_3" readonly="readonly" value="${order.billNo }" />
							...
							<dd class="row-dd">
								...
								<span class="form_textarea">
									<textarea id="memo" class="noborder" name="memo" readonly="readonly" style="width: 1020px"></textarea>
								</span>
							</dd>
						</dl>
					</div>
