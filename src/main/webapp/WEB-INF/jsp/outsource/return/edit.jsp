...
<title>编辑发外退货单</title>
<script type="text/javascript" src="${ctxStatic}/site/outsource/return/edit.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="发外管理-发外退货-编辑"></sys:nav>
				</div>
				<div class="top_nav">
					<shiro:hasPermission name="outsource:return:edit">
						<button class="nav_btn table_nav_btn" id="btn_save">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="outsource:return:edit,outsource:return:audit">
						...
						<div class="cl form_content">
							...
							<dl class="cl row-dl">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<phtml:list type="com.huayin.printmanager.persist.enumerate.ReturnGoodsType" textProperty="text" name="returnGoodsType" cssClass="input-txt input-txt_1 hy_select2" selected="${order.returnGoodsType }" />
									</span>
								</dd>
								<dd class="row-dd">
							...
							<tbody>
								<c:forEach var="detail" items="${order.detailList}" varStatus="status">
									<tr name="tr">
										...
										<td>
											<input class="tab_input" readonly="readonly" type="text" name="detailList.price" value="${detail.price }" />
										</td>
										<td>
										...
										<td>
											<input name="detailList.taxRateName" readonly="readonly" class="tab_input" type="text" value="${detail.taxRateName }"/>
										</td>
				...
				<div class="cl form_content">
					<dl class="cl row-dl-foot">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<input type="text" class="input-txt input-txt_10" id="sum_money" name="totalMoney" readonly="readonly" value="${order.totalMoney  }" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_3">金额(不含税)：</label>
							<span class="ui-combo-wrap" class="form_text">
								<input type="text" class="input-txt input-txt_10" id="sum_noTaxMoney" name="noTaxTotalMoney" readonly value="${order.noTaxTotalMoney  }" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_1">税 额：</label>
							<span class="ui-combo-wrap" class="form_text">
								<input type="text" class="input-txt input-txt_10" id="sum_tax" name="totalTax" readonly="readonly" value="${order.totalTax  }" />
							</span>
						</dd>
					...
					<dl class="cl row-dl-foot">
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<input name="createName" type="text" class="input-txt input-txt_10" readonly="readonly" value="${order.createName}" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_3">制单日期：</label>
							<span class="ui-combo-wrap" class="form_text">
								<input type="text" class="input-txt input-txt_10" readonly="readonly" value="<fmt:formatDate value="${order.createTime }" type="date" pattern="yyyy-MM-dd" />" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_1">审 核 人：</label>
							<span class="ui-combo-wrap" class="form_text">
								<input name="checkUserName" type="text" class="input-txt input-txt_10" readonly="readonly" value="${order.checkUserName}" />
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_1">审核日期：</label>
							<span class="ui-combo-wrap" class="form_text">
								<input name="checkTime" type="text" class="input-txt input-txt_10" readonly value="<fmt:formatDate value="${order.checkTime }" type="date" pattern="yyyy-MM-dd" />" />
							</span>
						</dd>
					</dl>
				</div>
