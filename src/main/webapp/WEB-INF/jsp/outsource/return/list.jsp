...
<title>发外退货表</title>
<script type="text/javascript" src="${ctxStatic}/site/outsource/return/list.js?v=${v}"></script>
</head>
<body>
			...
			<div class="cl">
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							<label class="form-label label_ui label_4">供应商名称：</label>
						...
						<dd class="row-dd">
							<label class="form-label label_ui label_4">退货单号：</label>
