...
<meta charset="UTF-8">
<title>来源发外到货</title>
<script type="text/javascript" src="${ctxStatic}/site/outsource/return/quick_select.js?v=${v}"></script>
</head>
<body>
				...
				<div class="cl layer_top">
					<div class="row-dd" style="margin-left: 5px">
						...
						<span class="ui-combo-wrap" class="form_text">
							...
							<input type="text" class="input-txt input-txt_9" id="billNo" name="billNo" value="${billNo }" placeholder="到货单号" />
						</span>
