...
<script type="text/javascript" src="${ctxStatic }/site/outsource/process/collect/procedure_class_list.js?v=${v }"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="发外管理-分析报表-发外汇总表(按工序)"></sys:nav>
				</div>
			</div>
			<!--头部END-->
			<!--查询表单START-->
				...
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<phtml:list items="${fns:basicList('PROCEDURECLASS')}" valueProperty="id" defaultValue="" defaultOption="请选择" name="procedureClassId" textProperty="name" cssClass="input-txt input-txt_13 hy_select2"></phtml:list>
						</dd>
						<dd class="row-dd">
