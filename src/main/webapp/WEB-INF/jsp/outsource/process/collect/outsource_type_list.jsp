...
<title>发外汇总--按发外类型</title>
<script type="text/javascript" src="${ctxStatic }/site/outsource/process/collect/outsource_type_list.js?v=${v }"></script>
</head>
<body>
				...
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<phtml:list cssClass="input-txt input-txt_13 hy_select2" defaultValue="" defaultOption="请选择" name="outSourceType" textProperty="text" type="com.huayin.printmanager.persist.enumerate.OutSourceType"></phtml:list>
						</dd>
						<dd class="row-dd">
