...
<title>查看发外到货单</title>
<script type="text/javascript" src="${ctxStatic }/site/outsource/arrive/view.js?v=${v }"></script>
</head>
<body>
<input type="hidden" value=' ${fns:toJson(order.detailList)}' id="orderDetailList">
<input type="hidden" value=' ${id}' id="arriveId">
	<div class="page-container">
		<div class="page-border">
			<!--导航按钮-->
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="发外管理-发外到货-查看"></sys:nav>
				</div>
				<div class="top_nav">
					...
					<c:if test="${order.isForceComplete eq 'NO'}">
						<c:if test="${order.isCheck eq 'NO'}">
							...
							<shiro:hasPermission name="outsource:arrive:audit">
								<button class="nav_btn table_nav_btn" id="btn_audit">审核</button>
							</shiro:hasPermission>
							<shiro:hasPermission name="outsource:arrive:del">
								<button class="nav_btn table_nav_btn" id="btn_del">删除</button>
							</shiro:hasPermission>
						</c:if>
						<c:if test="${order.isCheck eq 'YES'}">
							<shiro:hasPermission name="outsource:arrive:audit_cancel">
					...
					<shiro:hasPermission name="outsource:arrive:print">
									...
									<div class="template_div">
										<ul class="dropdown-menu" role="menu">
											<li id="btn_transmit_return">
												<a title="生成发外退货" href="javascript:;">生成发外退货</a>
											</li>
											<li id="btn_transmit_reconcil">
												<a title="生成发外对帐" href="javascript:;">生成发外对帐</a>
											</li>
										</ul>
									</div>
								</div>
				...
				<div class="form-wrap">
					<div class="cl form_content">
						<dl class="cl row-dl">
							...
							<dd class="row-dd">
								<label class="form-label label_ui">到货日期：</label>
								<span class="ui-combo-wrap">
