...
<title>外发到货明细</title>
<script type="text/javascript" src="${ctxStatic }/site/outsource/arrive/detail_list.js?v=${v }"></script>
</head>
<body>
				...
				<div class="cl order-info">
					...
					<dl class="cl hide_container" style="display: none;" id="more_div">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap">
								<phtml:list cssClass="input-txt input-txt_3s hy_select2" defaultValue="-1" defaultOption="全部" name="procedureType" textProperty="text" type="com.huayin.printmanager.persist.enumerate.ProcedureType"></phtml:list>
							</span>
						</dd>
						<dd class="row-dd">
							<label class="form-label label_ui label_1">源单单号：</label>
							<span class="ui-combo-wrap form_text">
								<input type="text" class="input-txt input-txt_5" name="sourceBillNo" id="sourceBillNo" />
							</span>
						</dd>
						<dd class="row-dd">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap form_text">
								<input type="text" class="input-txt input-txt_16" id="productName" />
