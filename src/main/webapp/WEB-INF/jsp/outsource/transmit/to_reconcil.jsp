...
<title>发外到货/退货转对账</title>
<script type="text/javascript" src="${ctxStatic}/site/outsource/transmit/to_reconcil.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="发外管理-转单功能-发外到货/退货转对账"></sys:nav>
				</div>
				<div class="top_nav">
					<shiro:hasPermission name="outsource:reconcil:create">
						<button class="nav_btn table_nav_btn" id="btn_transmit">生成外发对账单</button>
					</shiro:hasPermission>
				...
				<div class="cl order-info">
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap form_text wrap-width">
								<input type="text" class="input-txt input-txt_3" id="outSourceBillNo" />
							</span>
						</dd>
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap wrap-width">
								<input type="text" class="input-txt input-txt_8" id="supplierName" />
					...
					<dl class="cl row-dl" style="display: none;" id="more_div2">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap wrap-width">
								<input type="text" class="input-txt input-txt_8" id="productName" />
