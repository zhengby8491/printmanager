...
<title>工单转整单外发</title>
<script type="text/javascript" src="${ctxStatic}/site/outsource/transmit/to_process_product.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="发外管理-转单功能-工单转整单外发"></sys:nav>
				</div>
				<div class="top_nav">
					...
					<%-- <shiro:hasPermission name="outsource:transmit:cancelProductOut">
					...
					<dl class="cl row-dl">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap form_text">
								<input type="text" class="input-txt input-txt_3S" id="workBillNo" />
							</span>
						</dd>
						<dd class="row-dd">
