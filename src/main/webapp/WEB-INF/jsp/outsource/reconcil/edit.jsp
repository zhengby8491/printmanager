...
<title>编辑发外对账单</title>
<script type="text/javascript" src="${ctxStatic}/site/outsource/reconcil/edit.js?v=${v}"></script>
</head>
<body>
		...
		<div class="page-border">
			...
			<div class="cl">
				<div class="iframe-top">
					<sys:nav struct="发外管理-发外对账-编辑"></sys:nav>
				</div>
				<div class="top_nav">
					<shiro:hasPermission name="outsource:reconcil:edit">
						<button class="nav_btn table_nav_btn" id="btn_save">保存</button>
					</shiro:hasPermission>
					<shiro:hasManyPermissions name="outsource:reconcil:edit,outsource:reconcil:audit">
						...
						<div class="cl form_content">
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="text" class="input-txt input-txt_7" id="supplierName" readonly="readonly" name="supplierName" readonly="readonly" value="${order.supplierName }" />
									</span>
								</dd>
								<dd class="row-dd">
								...
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="text" class="input-txt input-txt_1 Wdate" onFocus="WdatePicker({lang:'zh-cn'})" name="reconcilTime" id="reconcilTime" value="<fmt:formatDate value="${order.reconcilTime}" type="date" pattern="yyyy-MM-dd" />" />
									</span>
								</dd>
								<dd class="row-dd">
							...
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="ui-combo-wrap">
										<input type="text" class="input-txt input-txt_11" name="supplierAddress" id="supplierAddress" value="${order.supplierAddress }" />
									</span>
								</dd>
								<dd class="row-dd">
								...
								<dd class="row-dd" style="display: none">
									<label class="form-label label_ui label_1">税 率：</label>
									<span class="ui-combo-wrap" class="form_text">
										<phtml:list items="${fns:basicList2('TAXRATE')}" valueProperty="id" textProperty="name" name="taxRate_public_select" cssClass="input-txt input-txt_3 hy_select2" />
									</span>
								</dd>
								<dd class="row-dd">
							...
							<dl class="cl row-dl">
								<dd class="row-dd">
									...
									<span class="form_textarea">
										<textarea class="noborder" name="memo" style="width: 884px" placeholder="说点什么...100个字符以内" onKeyUp="Helper.doms.textarealength(this,100)">${order.memo }</textarea>
							...
							<tbody>
								<c:forEach var="detail" items="${order.detailList}" varStatus="status">
									<tr name="tr">
										...
										<td>
											<input class="tab_input bg_color 
											<c:if test="${detail.sourceBillType=='OUTSOURCE_OR' }">constraint_positive</c:if>
				...
				<div class="cl form_content">
					<dl class="cl row-dl-foot">
						<shiro:hasPermission name="outsource:reconcil:money">
							...
							<dd class="row-dd">
								...
								<span class="ui-combo-wrap" class="form_text">
									<input type="text" class="input-txt input-txt_3" id="sum_noTaxMoney" name="noTaxTotalMoney" readonly="readonly" value="${order.noTaxTotalMoney  }" />
								</span>
							</dd>
							<dd class="row-dd">
					...
					<dl class="cl row-dl-foot">
						...
						<dd class="row-dd">
							...
							<span class="ui-combo-wrap" class="form_text">
								<input name="checkTime" type="text" class="input-txt input-txt_3" readonly="readonly" value="<fmt:formatDate value="${order.checkTime }" type="date" pattern="yyyy-MM-dd" />" />
							</span>
						</dd>
					</dl>
				</div>
