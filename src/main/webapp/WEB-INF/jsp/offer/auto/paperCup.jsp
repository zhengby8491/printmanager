...
<script type="text/javascript" src="${ctxStatic}/site/offer/auto/paperCup.js?v=${v}"></script>
<print:body>
	<!-- 导航按钮 -->
	<print:nav title="报价系统-自动报价-${offerType.text }自动报价">
		<shiro:hasPermission name="offer:auto:papercup:save">
			...
			<print:tableContent formId="quote_form">
				<thead>
					<tr>
						...
						</span> <span style="font-size: 11px;"></span></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td width="10%">成品尺寸（mm）</td>
						<td width="300px" style="text-align: left;"><span class="ui-combo-wrap" style="margin-left: 23px"> <phtml:list name="spec" textProperty="text" valueProperty="style" cssClass="input-txt input-txt_21 hy_select" type="com.huayin.printmanager.persist.enumerate.OfferPaperCupSpecType" selected="" />
