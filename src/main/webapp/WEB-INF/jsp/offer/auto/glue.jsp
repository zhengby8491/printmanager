...
<print:body>
	...
	<print:nav title="报价系统-自动报价-${offerType.text }自动报价">
		<shiro:hasPermission name="offer:auto:glue:save"> 
				...
				<thead>
					<tr>
						<th width="60" colspan="2">
							...
							<span style="font-size: 11px;">：胶印平张不干胶，胶印平张标签</span>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td width="300px" style="text-align: left;">
							<span class="hiddenSpan">
								<span class="mgl">长</span>
								<input type="text" id="length" name="styleLength" class="constraint_decimal_negative input-txt input-txt_25 whiteBg">
								<span class="mgl">宽</span>
								<input type="text" id="width" name="styleWidth" class="constraint_decimal_negative input-txt input-txt_25 whiteBg">
							</span>
						</td>
					</tr>
					<tr>
