...
<print:body>
	...
	<print:nav title="报价系统-自动报价-${offerType.text }自动报价">
		<shiro:hasPermission name="offer:auto:bill:save">
					...
					<tr>
						<th width="60" colspan="2">
							<span style="font-size: 20px; font-family: 'STHeiti'">
								...
								<input type="hidden" id="offerType" value="${offerType.text }">
							</span>
							<span style="font-size: 11px;">：多联单，多联复写单</span>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td width="300px" style="text-align: left;">
							...
							<span style="margin-left: 23px;">
								<phtml:list name="sheetType" textProperty="text" cssClass="input-txt input-txt_29 hy_select" type="com.huayin.printmanager.persist.enumerate.OfferSheetType" />
							</span>
							<!-- 设计费 -->
