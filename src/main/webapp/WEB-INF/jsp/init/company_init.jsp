...
<title>${projectName}-初始化数据二</title>
		...
		$("#companyInitForm").validate({
			...
			rules : {
				name : {
					...
					remote : {
						type : "POST",
						url : Helper.basePath + '/sys/company/existForRegister',
						dataType : "json",
						data : {
							"name" : function()
							{
			...
			messages : {
				name : {
					required : '<span class="m_error"><i>*</i>请输入公司名称</span>',
					maxlength : '<span class="m_error"><i>*</i>最多可以输入 {0}个字符</span>',
					remote : '<span class="m_error"><i>*</i>公司名称已被注册</span>'
				},
				email : {
					isEmail : '<span class="m_error"><i>*</i>邮箱格式不正确</span>'
				},
				linkName : {
					required : '<span class="m_error"><i>*</i>请输入联系人</span>',
					maxlength : '<span class="m_error"><i>*</i>最多可以输入 {0}个字符</span>',
				},
				tel : {
					required : '<span class="m_error"><i>*</i>请输入联系方式</span>',
					isTel : '<span class="m_error"><i>*</i>请正确填写您的联系方式</span>'
				}
			},
			onkeyup : false,
			onfocusout : true,
			...
			<div class="main_wrap">
				<div class="main_container">
					...
					<div class="main_section">
						<form method="post" id="companyInitForm" action="${ctx }/sys/company/initCompany">
							<h3>公&nbsp;司&nbsp;信&nbsp;息</h3>
							<div class="m_item">
								<label class="m_label">
									<i>*</i>
								...
								<input class="m_input" type="text" name="name" id="name" />
							</div>
							<div class="m_item">
								<label class="m_label">邮箱：</label>
								<input class="m_input" type="text" id="email" name="email" />
							</div>
							<div class="m_item">
								<label class="m_label">传真：</label>
								<input class="m_input" type="text" name="fax" />
							</div>
							<div class="m_item m_address">
								<label class="m_label">地址：</label>
								<select class="m_input hy_select2" id="cmbProvince" name="province"></select>
								<select class="m_input hy_select2" id="cmbCity" name="city"></select>
								<select class="m_input hy_select2" id="cmbArea" name="county"></select>
							</div>

							<div class="m_item">
								<label class="m_label">详细地址：</label>
								<input class="m_input" type="text" name="address" id="address" />
							</div>
							<div class="m_item">
								<label class="m_label">
									<i>*</i>
								...
								<input class="m_input" type="text" id="linkName" name="linkName" />
							</div>
							<div class="m_item">
								<label class="m_label">
									<i>*</i>
								...
								<input class="m_input" type="text" id="tel" name="tel" value="${loginUser.mobile}" />
							</div>
							<div class="m_item">
								<input class="m_submit m_active" type="submit" value="下&nbsp;一&nbsp;步" />
							</div>
						</form>
					</div>
					<!--公司信息End-->
