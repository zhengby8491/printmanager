...
<script type="text/javascript" src="${ctxStatic}/site/basic/materialClass/create.js?v=${v }"></script>
<title>添加材料类型 - 材料类型管理</title>
</head>
<body>
		...
		<form id="jsonForm">
			<div class="cl row-div">
				...
				<div class="ui-combo-wrap form_text error_tip">
					<input type="text" class="input-txt input-txt_7 constraint_number" value="${fns:nextSort('materialClass')}" placeholder="" id="sort" name="sort">
				</div>
			</div>
			<div class="cl row-div">
				<label class="form-label label_ui label_4mar">
