...
<script type="text/javascript" src="${ctxStatic}/site/basic/productClass/create.js?v=${v }"></script>
<title>添加产品类型 - 产品类型管理</title>
</head>
<body>
		...
		<form id="jsonForm">
			<div class="cl row-div">
				...
				<div class="ui-combo-wrap form_text error_tip">
					<input type="text" class="input-txt input-txt_7 constraint_number" value="${fns:nextSort('productClass')}" placeholder="" id="sort" name="sort">
				</div>
			</div>
			<div class="cl row-div">
				<label class="form-label label_ui label_4mar">
				...
				<div class="ui-combo-wrap form_text div_select_wrap">
					<phtml:list name="productType" textProperty="text" cssClass="hy_select2" type="com.huayin.printmanager.persist.enumerate.ProductType"></phtml:list>
				</div>
			</div>
			<div class="cl row-div">
				<label class="form-label label_ui label_4mar">
