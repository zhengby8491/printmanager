...
<script type="text/javascript" src="${ctxStatic}/site/basic/deliveryClass/create.js?v=${v }"></script>
<title>快捷添加送货方式 - 送货方式管理</title>
</head>
<body>
	<div class="layer_container">
		<form id="jsonForm">
			<div class="cl row-div" style="display: none;">
				<label class="form-label label_ui label_4mar">
					<span class="c-red">*</span>
					排序：
				</label>
				<div class="ui-combo-wrap form_text error_tip">
					<input type="text" class="input-txt input-txt_7 constraint_number" value="${fns:nextSort('deliveryClass')}" placeholder="" id="sort" name="sort">
				</div>
			</div>
