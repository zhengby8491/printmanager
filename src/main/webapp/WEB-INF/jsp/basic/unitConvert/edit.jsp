...
<script type="text/javascript" src="${ctxStatic}/site/basic/unitConvert/edit.js?v=${v }"></script>
<title>编辑单位换算 - 单位换算管理</title>
<style type="text/css">
.btn_bar .nav_btn {
	margin: 0 8px;
	padding: 4px 10px
...
<body>
	<div class="layer_container">
		<form id="jsonForm">
			<input type="hidden" id="id" name="id" value="${unitConvert.id }" />
			<div class="cl row-div" style="margin: 10px 20px 0">
				...
				<input type="hidden" id="formula" name="formula" value="${unitConvert.formula }" />
			</div>
			...
			<div class="cl row-div">
				...
				<div class="ui-combo-wrap form_text">
					<input type="text" class="input-txt input-txt_7" value="${unitConvert.name }" name="name" id="name" />
				</div>
			</div>
			<div class="cl row-div">
				<label class="form-label label_ui label_4mar">源单位：</label>
				<div class="ui-combo-wrap form_text">
					<phtml:list items="${fns:basicList('UNIT')}" valueProperty="id" textProperty="name" name="sourceUnitId" cssClass="input-txt input-txt_7 hy_select2" selected="${unitConvert.sourceUnitId }" />
				</div>
			</div>
			<div class="cl row-div">
				<label class="form-label label_ui label_4mar">换算单位：</label>
				<div class="ui-combo-wrap form_text">
					<phtml:list items="${fns:basicList('UNIT')}" valueProperty="id" textProperty="name" name="conversionUnitId" cssClass="input-txt input-txt_7 hy_select2" selected="${unitConvert.conversionUnitId }" />
				</div>
			</div>
