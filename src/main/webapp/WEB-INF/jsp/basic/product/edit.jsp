...
<script type="text/javascript" src="${ctxStatic}/site/basic/product/edit.js?v=${v}"></script>
<title>编辑产品信息 - 产品信息管理</title>
<style type="text/css">
.info_table {
	width: 620px;
	left: 8px;
...
<body>
	<div class="layer_container">
		...
		<form id="jsonForm">
			...
			<input type="hidden" value="${product.code}" id="code" name="code">
			<div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list items="${fns:basicList('PRODUCTCLASS')}" valueProperty="id" selected="${product.productClassId}" cssClass="hy_select2" name="productClassId" textProperty="name"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="input-txt input-txt_7" value="${product.customerMaterialCode}" placeholder="" id="customerMaterialCode" name="customerMaterialCode">
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="input-txt input-txt_7" value="${product.code}" placeholder="" />
						</div>
					</div>
				</div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="input-txt input-txt_7" value="${product.name}" placeholder="" id="name" name="name">
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="input-txt input-txt_7" value="${product.specifications}" id="specifications" name="specifications">
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list items="${fns:basicList('UNIT')}" valueProperty="id" selected="${product.unitId}" cssClass="hy_select2" name="unitId" textProperty="name"></phtml:list>
						</div>
					</div>
				</div>
				<div class="cl">
					...
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="isValid" textProperty="text" selected="${product.isValid}" cssClass="hy_select2" type="com.huayin.printmanager.persist.enumerate.BoolValue"></phtml:list>
						</div>
					</div>
				</div>
				<div class="cl">
			...
			<div class="img_table">
				...
				<div class="info_table_container" id="containerDiv">
					...
					<div id="show_img" name="productImg" class="img_div">
