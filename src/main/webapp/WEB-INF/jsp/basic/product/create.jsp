			...
			<div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list items="${fns:basicList('PRODUCTCLASS')}" valueProperty="id" cssClass="hy_select2" name="productClassId" textProperty="name"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
				...
				<div class="cl">
					...
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="input-txt input-txt_7" value="" placeholder="" id="specifications" name="specifications">
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list items="${fns:basicList('UNIT')}" valueProperty="id" cssClass="hy_select2" name="unitId" textProperty="name"></phtml:list>
						</div>
					</div>
				</div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="constraint_decimal_negative input-txt input-txt_7" value="" placeholder="" id="salePrice" name="salePrice">
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="isPublic" textProperty="text" selected="NO" cssClass="hy_select2" type="com.huayin.printmanager.persist.enumerate.BoolValue"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="isValid" textProperty="text" cssClass="hy_select2" type="com.huayin.printmanager.persist.enumerate.BoolValue"></phtml:list>
						</div>
					</div>
				</div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="form_textarea_rlt">
							<textarea name="memo" id="memo" class="input-txt_7 " placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="Helper.doms.textarealength(this,100)" style="width: 824px; resize: none"></textarea>
