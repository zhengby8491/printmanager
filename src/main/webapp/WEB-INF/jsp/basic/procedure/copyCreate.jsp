			...
			<div>
				<div class="cl">
					...
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="procedureType" textProperty="text" cssClass="hy_select2" selected="${procedure.procedureType}" type="com.huayin.printmanager.persist.enumerate.ProcedureType"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list items="${fns:basicList('PROCEDURECLASS')}" valueProperty="id" cssClass="hy_select2" selected="${procedure.procedureClassId}" name="procedureClassId" textProperty="name"></phtml:list>
						</div>
					</div>
				</div>
				<div class="cl">
					...
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<!-- FIX bug ZHANGTAI 2210 ${procedure.name } -->
					...
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="produceType" textProperty="text" cssClass="hy_select2" selected="${procedure.produceType}" type="com.huayin.printmanager.persist.enumerate.ProduceType"></phtml:list>
						</div>
					</div>
				</div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="isProduce" textProperty="text" cssClass="hy_select2" selected="${procedure.isProduce}" type="com.huayin.printmanager.persist.enumerate.BoolValue"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="isQuotation" textProperty="text" cssClass="hy_select2" selected="${procedure.isQuotation}" type="com.huayin.printmanager.persist.enumerate.BoolValue"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
				...
				<div class="cl">
					...
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap">
							<phtml:list name="scheduleDataSource" textProperty="text" cssClass="hy_select2" selected="${procedure.scheduleDataSource}" type="com.huayin.printmanager.persist.enumerate.ScheduleDataSource"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
				...
				<div class="cl">
					<div class="row-div">
						...
						<div class="form_textarea_rlt">
							<textarea name="memo" id="memo" placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="Helper.doms.textarealength(this,100)" style="width: 824px; resize: none">${procedure.memo }</textarea>
