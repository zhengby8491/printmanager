			...
			<div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap error_tip">
							<phtml:list name="type" textProperty="text" cssClass="hy_select2" selected="${supplier.type}" type="com.huayin.printmanager.persist.enumerate.SupplierType"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap error_tip">
							<phtml:list items="${fns:basicList('SUPPLIERCLASS')}" cssClass="hy_select2" selected="${supplier.supplierClassId}" valueProperty="id" name="supplierClassId" textProperty="name"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
				...
				<div class="cl">
					...
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap error_tip">
							<phtml:list items="${fns:basicList2('EMPLOYEE')}" cssClass="hy_select2" selected="${supplier.employeeId}" valueProperty="id" name="employeeId" textProperty="name"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap error_tip">
							<phtml:list name="currencyType" textProperty="text" cssClass="hy_select2" selected="${supplier.currencyType}" type="com.huayin.printmanager.persist.enumerate.CurrencyType"></phtml:list>
						</div>
					</div>
				</div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text div_select_wrap error_tip">
							<phtml:list items="${fns:basicList2('TAXRATE')}" cssClass="hy_select2" selected="${supplier.taxRateId}" valueProperty="id" name="taxRateId" textProperty="name"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
						...
						<div class="ui-combo-wrap form_text div_select_wrap error_tip">
							<phtml:list items="${fns:basicList2('PAYMENTCLASS')}" cssClass="hy_select2" selected="${supplier.paymentClassId}" valueProperty="id" name="paymentClassId" textProperty="name"></phtml:list>
						</div>
					</div>
					<div class="row-div">
						<label class="form-label label_ui label_4mar">
				...
				<div class="cl">
					<div class="row-div">
						...
						<div class="form_textarea_rlt">
							<textarea name="memo" id="memo" class="input-txt_7 " placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="Helper.doms.textarealength(this,100)" style="width: 825px;; resize: none">${supplier.memo}</textarea>
