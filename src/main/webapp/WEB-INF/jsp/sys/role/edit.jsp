...
<script type="text/javascript" src="${ctxStatic}/site/sys/role/edit.js?v=${v }"></script>
</head>
<body>
			...
			<div class="cl">
				...
				<div class="row-div">
					...
					<div class="ui-combo-wrap form_text error_tip">
						<input type="text" class="input-txt input-txt_7" placeholder="" id="name" name="name" value="${role.name }" />
					</div>
				</div>
				<div class="row-div">
					<label class="form-label label_ui label_1">备注：</label>
					<div class="form_textarea_rlt">
						<textarea name="memo" id="memo" class="input-txt_7 " placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="Helper.doms.textarealength(this,100)" style="height: 24px; width: 350px">${role.memo }</textarea>
