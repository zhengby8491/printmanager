...
<script type="text/javascript">
    $(function()
    {
        ...
        $("#bootTable").bootstrapTable({
            url: Helper.basePath + "/sys/notice/ajaxList",
            method: "post",
    ...
    {
      var url = Helper.basePath + '/sys/notice/edit/' + id;
        Helper.popup.show("编辑公告", url, "600", "400");
    }
    
    /*新增*/
  	function create() {
  	    var url = Helper.basePath + '/sys/notice/create';
  	    Helper.popup.show("创建公告", url, "600", "400");
  	}
  	...
  	function notice_del(obj, id) {
     	...
     	                cache: true,
     	                type: "POST",
     	                url:Helper.basePath + '/sys/notice/del/'+id,		              
     	                async: false,
     					dataType:"json", 
     	...
     	                success: function(data) {
     						if(data.success){
     						    ...
     						    window.location.href=Helper.basePath + '/sys/notice/list';
     						}else{
