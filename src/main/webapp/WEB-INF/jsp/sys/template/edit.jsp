...
<body>
	...
	<div class="page-container">
		<div class="page-border">
			...
			<input type="hidden" name="templateId" id="templateId" value="${params.id }" />
												...
												uiName,
												{
													execCommand : function() {
														var dialog = new UE.ui.Dialog(
																{
																	iframeUrl : Helper.basePath
																			+ '/sys/template/selectDataModel?billType='
																			+ $("#billType").val(),
																	name : 'data',
																	editor : this,
																	title : '报表设计器 - 数据源',
												...
												uiName,
												{
													execCommand : function() {
														var dialog = new UE.ui.Dialog(
																{
																	iframeUrl : Helper.basePath
																			+ '/sys/template/select_template?billType='+ $("#billType").val(),
																	name : 'template',
																	editor : this,
																	title : '报表设计器 - 模板',
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#btn_save").click(function() {
				...
				$.ajax({
					type : "POST",
					url : Helper.basePath + '/template/editByAdmin',
					data : {
