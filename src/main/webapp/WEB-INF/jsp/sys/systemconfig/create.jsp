...
<script type="text/javascript" src="${ctxStatic}/site/sys/systemconfig/create.js?s"></script>
<title>添加参数 - 参数设置</title>
</head>
<body>
			...
			<div>
				...
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="input-txt input-txt_7" id="value" name="value" />
						</div>
					</div>
				</div>
				<div class="cl">
					<div class="row-div">
						...
						<div class="ui-combo-wrap form_text error_tip">
							<input type="text" class="input-txt input-txt_7" id="description" name="description" />
						</div>
					</div>
