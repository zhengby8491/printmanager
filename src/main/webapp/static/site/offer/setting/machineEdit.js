...
$(function()
{
	...
	*/
	function initBtn()
	{
		...
		{
			location.href = Helper.basePath + "/offer/setting/machineView/" + $("#machineId").val() + "?type=" + $("#machineOfferType").val();
		});
	}
	...
	*/
	...
	function formSubmitCustomformula()
	{
		...
		if (sm && sm.machine && sm.machine.length == 1)
		{
			...
			postData.offerFormula.id = $("#customId").val();
	...
	{
		Helper.request({
			url : Helper.basePath + "/offer/setting/updateMachine",
			data : postData,
