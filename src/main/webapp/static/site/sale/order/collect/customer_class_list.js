$(function()
{
	...
	{
		var url = Helper.basePath + '/sale/order/collect_customer_list/' + $(this).val();
		var title = "销售订单汇总表(按客户)";
	...
	$("#year").select('/sale/order/getYearsFromSaleOrder', {}, function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/sale/order/sumSaleOrderByCustomer/class",
			method : "post",
			...
			cookieIdTable : "print_sale_sum_customer_class",// 必须制定唯一的表格cookieID
		...
		$("#bootTable").on('load-success.bs.table column-switch.bs.table page-change.bs.table search.bs.table', function()
		{
			...
			if ($(".glyphicon-th").next().html() == '')
			{
				...
				if (!Helper.basic.hasPermission('sale:collect_customer:export'))
				{
