...
{
	/* 判断当前用户是否有权限查看金额 */
	var hasPermission = Helper.basic.hasPermission('stock:material_otherout:money2');
	/* 选择材料 */
	...
	$("#bootTable").bootstrapTable({
		url : Helper.basePath + "/stockmaterial/otherout/ajaxDetailList",
		method : "post",
		...
		cookieIdTable : "print_stockmaterial_otherout_detail",// 必须制定唯一的表格cookieID
		...
		onDblClickRow : function(row)
		{
			...
			var url = Helper.basePath + '/stockmaterial/otherout/view/' + row.master.id;
			var title = "材料其它出库";
