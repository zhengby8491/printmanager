...
$(function()
{
	...
	{
		location.href = Helper.basePath + '/stockmaterial/adjust/view/' + $("input[name='id']").val();
	});
	setRowIndex();
	// 保存
...
{
	Helper.request({
		url : Helper.basePath + "/stockmaterial/adjust/update",
		data : $("#form_adjust").formToJson(),
