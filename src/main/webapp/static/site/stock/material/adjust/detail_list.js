...
{
	/* 判断当前用户是否有权限查看金额 */
	var hasPermission = Helper.basic.hasPermission('stock:materialAdjust_detail:money');
	/* 选择材料 */
	...
	$("#bootTable").bootstrapTable({
		url : Helper.basePath + "/stockmaterial/adjust/ajaxDetailList",
		method : "post",
		...
		cookieIdTable : "print_stockmaterial_adjust_detail",// 必须制定唯一的表格cookieID
		...
		onDblClickRow : function(row)
		{
			...
			var url = Helper.basePath + '/stockmaterial/adjust/view/' + row.master.id;
			var title = "材料库存调整";
