...
{
	/* 判断当前用户是否有权限查看金额 */
	var hasPermission = Helper.basic.hasPermission('stock:materialOtherin:money2');
	/* 选择材料 */
	...
	$("#bootTable").bootstrapTable({
		url : Helper.basePath + "/stockmaterial/otherin/ajaxDetailList",
		method : "post",
		...
		cookieIdTable : "print_stockmaterial_otherin_detail",// 必须制定唯一的表格cookieID
		...
		onDblClickRow : function(row)
		{
			...
			var url = Helper.basePath + '/stockmaterial/otherin/view/' + row.master.id;
			var title = "材料其它入库";
