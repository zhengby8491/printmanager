$(function()
	{
		/* 判断当前用户是否有权限查看金额 */
		var hasPermission = Helper.basic.hasPermission('stock:material_logdetail:money');
		/* 选择材料 */
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/stock/material/ajaxLogDetailList",
			method : "post",
			...
			cookieIdTable : "print_stock_material_logDetailList",//必须制定唯一的表格cookieID
			...
			onLoadSuccess : function()
			{
				...
				if ($(".glyphicon-th").next().html() == '')
				{
					...
					;
					if (!Helper.basic.hasPermission('stock:material_logdetail:export'))
					{
	...
	function queryParams(params)
	{
		...
		params['searchContent'] = $("#billType").val();
