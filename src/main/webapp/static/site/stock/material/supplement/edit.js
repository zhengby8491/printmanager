...
$(function()
{
	...
	{
		location.href = Helper.basePath + '/stockmaterial/supplement/view/' + $("input[name='id']").val();
	});
	setRowIndex();
...
function form_submit()
{
	...
	Helper.request({
		url : Helper.basePath + "/stockmaterial/supplement/update",
