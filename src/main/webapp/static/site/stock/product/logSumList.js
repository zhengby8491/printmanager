$(function() {
		/* 判断当前用户是否有权限查看金额 */
		var hasPermission = Helper.basic.hasPermission('stock:product:money');
		/* 选择成品 */
		$("#product_quick_select").click(
				function() {
					Helper.popup.show('选择成品', Helper.basePath
							+ '/quick/product_select?multiple=false',
							'800', '500');
				});
				...
				.bootstrapTable(
						{
							...
							cookieIdTable : "print_stock_product_logSumList",//必须制定唯一的表格cookieID
							...
							columns : [
									...
									onLoadSuccess : function() {
									    ...
									    if($(".glyphicon-th").next().html() == ''){
									        ...
									        if(!Helper.basic.hasPermission('stock:productLogsum:export')){
