/* 判断当前用户是否有权限查看金额 */
	...
	function form_submit()
	{
		...
		Helper.request({
			url : Helper.basePath + "/stockproduct/adjust/save",
			data : data,
	...
	function getCallInfo_product_stock(content)
	{
		for (var i = 0; i < content.length; i++)
		{
			...
			var str='<tr><td name="rowIndex">1</td>'
				...
				+'<td style="display:none"><input name="detailList.productClassId" class="tab_input" type="hidden" value="'+obj.product.productClassId+'"/></td>'
				+'<td style="display:none"><input name="detailList.stockProductlId" class="tab_input" type="hidden" value="'+obj.id+'"/></td>'
