$(function()
	{
		/* 判断当前用户是否有权限查看金额 */
		var hasPermission = Helper.basic.hasPermission('stock:productAdjust_detail:money');
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/stockproduct/adjust/ajaxDetailList",
			method : "post",
			...
			cookieIdTable : "print_stockproduct_adjust_detail",//必须制定唯一的表格cookieID
			...
			onDblClickRow : function(row)
			{
				...
				var url = Helper.basePath + '/stockproduct/adjust/view/' + row.master.id;
				var title = "成品库存调整";
