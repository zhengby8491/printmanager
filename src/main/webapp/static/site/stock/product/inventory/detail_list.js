...
{
	/* 判断当前用户是否有权限查看金额 */
	var hasPermission = Helper.basic.hasPermission('stock:productInventory_detail:money');
	/* 选择产品 */
	...
	$("#bootTable").bootstrapTable({
		url : Helper.basePath + "/stockproduct/inventory/ajaxDetailList",
		method : "post",
		...
		cookieIdTable : "print_stockproduct_inventory_detail",// 必须制定唯一的表格cookieID
		...
		onDblClickRow : function(row)
		{
			...
			var url = Helper.basePath + '/stockproduct/inventory/view/' + row.master.id;
			var title = "成品库存盘点";
