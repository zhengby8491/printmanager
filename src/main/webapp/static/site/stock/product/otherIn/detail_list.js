...
{
	/* 判断当前用户是否有权限查看金额 */
	var hasPermission = Helper.basic.hasPermission('stock:product_otherin:money');
	...
	$("#bootTable").bootstrapTable({
		url : Helper.basePath + "/stockproduct/otherin/ajaxDetailList",
		method : "post",
		...
		cookieIdTable : "print_stockproduct_otherin_detail",// 必须制定唯一的表格cookieID
		...
		onDblClickRow : function(row)
		{
			...
			var url = Helper.basePath + '/stockproduct/otherin/view/' + row.master.id;
			var title = "成品其它入库";
