$(function()
{
	...
	{
		var url = Helper.basePath + '/purch/sum/by_supplier_name';
		var title = "供应商采购订单汇总";
	...
	$("#year").select('/purch/sum/getYearsFromPurchOrder', {}, function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/purch/sum/by_supplier_class_list",
			method : "post",
			...
			cookieIdTable : "print_purch_sum_supplier_class",// 必须制定唯一的表格cookieID
	...
	$("#bootTable").on('load-success.bs.table column-switch.bs.table page-change.bs.table search.bs.table', function()
	{
		...
		if ($(".glyphicon-th").next().html() == '')
		{
			...
			if (!Helper.basic.hasPermission('purch:by_supplier:export'))
			{
