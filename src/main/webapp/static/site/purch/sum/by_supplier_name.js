$(function()
{
	...
	{
		var url = Helper.basePath + '/purch/sum/by_supplier_class';
		var title = "供应商采购订单汇总";
	...
	$("#year").select('/purch/sum/getYearsFromPurchOrder', {}, function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/purch/sum/by_supplier_name_list",
			method : "post",
			...
			cookieIdTable : "print_purch_sum_supplier_name",// 必须制定唯一的表格cookieID
