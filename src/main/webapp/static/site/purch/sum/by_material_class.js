$(function()
{
	...
	{
		var url = Helper.basePath + '/purch/sum/by_material_name';
		var title = "原材料采购订单汇总";
	...
	$("#year").select('/purch/sum/getYearsFromPurchOrder', {}, function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/purch/sum/by_material_class_list",
			method : "post",
			...
			cookieIdTable : "print_purch_sum_material_class",// 必须制定唯一的表格cookieID
