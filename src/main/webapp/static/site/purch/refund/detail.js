...
{
	/* 判断当前用户是否有权限查看金额 */
	var hasPermission = Helper.basic.hasPermission('purch:refund_detail:money');
	// 查询，刷新table
	...
	$("#detailList").bootstrapTable({
		url : Helper.basePath + "/purch/refund/ajaxDetailList",
		method : "post",
		...
		cookieIdTable : "print_purch_refundDetial_master",// 必须制定唯一的表格cookieID
		...
		onLoadSuccess : function()
		{
			...
			if ($(".glyphicon-th").next().html() == '')
			{
				...
				if (!Helper.basic.hasPermission('purch:refund_detail:export'))
				{
