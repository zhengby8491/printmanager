...
$(function(){
	...
	// ------ 初始化数据
	$("#invoiceInfor").find("option[value='"+$("#purchaseRecordInvoiceInfor").val()+"']").attr("selected","selected").change();
	$("#orderState").find("option[value='"+$("#purchaseRecordOrderState").val()+"']").attr("selected","selected").change();
// 	$("#invoiceInfor").trigger('change');
