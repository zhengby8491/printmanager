$(function()
{
	...
	{
		var url = Helper.basePath + '/outsource/process/collect_supplier_list/' + $(this).val();
		var title = "发外汇总表(按加工商)";
	...
	{
		Helper.popup.show('选择供应商', Helper.basePath + '/quick/supplier_select?multiple=false', '800', '490');
	});
	...
	$("#year").select('/outsource/process/getYearsFromOutSourceProcess', {}, function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/outsource/process/sumOutsourceBySupplier/name",
			method : "post",
			...
			cookieIdTable : "print_sale_sum_customer_name",// 必须制定唯一的表格cookieID
	...
	$("#bootTable").on('load-success.bs.table column-switch.bs.table page-change.bs.table search.bs.table', function()
	{
		...
		if ($(".glyphicon-th").next().html() == '')
		{
			...
			if (!Helper.basic.hasPermission('outsource:collect_supplier:export'))
			{
