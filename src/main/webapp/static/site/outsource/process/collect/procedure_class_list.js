$(function()
{
	...
	{
		var url = Helper.basePath + '/outsource/process/collect_procedure_list/' + $(this).val();
		var title = "发外汇总表(按工序)";
	...
	$("#year").select('/outsource/process/getYearsFromOutSourceProcess', {}, function()
	{
		...
		$("#bootTable").bootstrapTable({
			url : Helper.basePath + "/outsource/process/sumOutsourceByProcedure/class",
			method : "post",
			...
			cookieIdTable : "print_outsource_sum_procedure_class",// 必须制定唯一的表格cookieID
	...
	$("#bootTable").on('load-success.bs.table column-switch.bs.table page-change.bs.table search.bs.table', function()
	{
		...
		if ($(".glyphicon-th").next().html() == '')
		{
			...
			if (!Helper.basic.hasPermission('outsource:collect_procedure:export'))
			{
