 ...
 */
public class ReceiveCheckDetailVo
{
	private Long id;
	...
	public ReceiveCheckDetailVo(Long id, String productName, BigDecimal sourceMoney, BigDecimal sourceBalanceMoney, BigDecimal money)
	{
		super();
		this.id = id;
		this.productName = productName;
