 ...
 */
public class WriteoffPaymentDetailCheckVo
{
	private Long id;
	...
	public WriteoffPaymentDetailCheckVo(Long id, String name, String style, BigDecimal sourceMoney, BigDecimal sourceBalanceMoney, BigDecimal money)
	{
		super();
		this.id = id;
		this.name = name;
	...
	public WriteoffPaymentDetailCheckVo()
	{
		super();
	}
