...
public class CaptchaServlet extends HttpServlet
{
	...
	{
		String session_captcha = (String) request.getSession().getAttribute(SysConstants.SESSION_KEY_LOGIN_PARAM_CAPTCHA);
		...
		if (session_captcha != null)
		{
			if (wanneng == null)
			{
				isValidate = captcha.toUpperCase().equals(session_captcha.toUpperCase());
			}
			else
			{
				isValidate = captcha.toUpperCase().equals(session_captcha.toUpperCase()) || captcha.toUpperCase().equals(wanneng.toUpperCase());
			}
		}
	...
	{
		String _captcha = request.getParameter(SysConstants.SESSION_KEY_LOGIN_PARAM_CAPTCHA); // AJAX验证，成功返回true
	...
	private void createImage(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		request.getSession().setAttribute(SysConstants.SESSION_KEY_LOGIN_PARAM_CAPTCHA, s);
