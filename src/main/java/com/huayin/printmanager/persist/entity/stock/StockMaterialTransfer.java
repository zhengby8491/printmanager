 ...
 */
@Entity
@Table(name = "stock_material_transfer")
public class StockMaterialTransfer extends BaseBillMasterTableEntity
{
	 ...
	 */
	@Transient
	private List<StockMaterialTransferDetail> detailList;
	...
	public List<StockMaterialTransferDetail> getDetailList()
	{
		return detailList;
	}

	public void setDetailList(List<StockMaterialTransferDetail> detailList)
	{
