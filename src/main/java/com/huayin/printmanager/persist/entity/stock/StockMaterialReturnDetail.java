 ...
 */
@Entity
@Table(name = "stock_material_return_detail")
public class StockMaterialReturnDetail extends StockMaterialDetailBaseEntity
{
	 ...
	 */
	@Transient
	private StockMaterialReturn master;
	...
	public StockMaterialReturn getMaster()
	{
		return master;
	}

	public void setMaster(StockMaterialReturn master)
	{
		this.master = master;
	}
