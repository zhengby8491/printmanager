 ...
 */
@Entity
@Table(name = "stock_material_otherout_detail")
public class StockMaterialOtherOutDetail extends StockMaterialDetailBaseEntity
{
	 ...
	 */
	@Transient
	private StockMaterialOtherOut master;
	...
	public StockMaterialOtherOut getMaster()
	{
		return master;
	}

	public void setMaster(StockMaterialOtherOut master)
	{
		this.master = master;
	}
